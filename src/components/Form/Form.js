                ...
                <div className='mt-4 bg-white shadow-md rounded-lg text-left'>
                    ...
                    <div className='px-8 py-6'>
                        ...
                        <div className='flex justify-between items-baseline'>
                            <button className='mt-4 bg-indigo-500 text-white  py-1 px-6 rounded-md hover:bg-indigo-600'>Login</button>
                            <Link to='/signup' className='mx-3' ><small >Don't have a Account?</small><small className='text-sm hover:underline px-2' >Sign up</small></Link>
                        </div>
                        <div>
